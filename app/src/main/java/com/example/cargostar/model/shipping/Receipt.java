...
@Entity(tableName = "receipt",
        foreignKeys = {@ForeignKey(entity = TransitPoint.class, parentColumns = "transit_point_id", childColumns = "current_location_id", onDelete = ForeignKey.CASCADE, onUpdate = ForeignKey.CASCADE)},
